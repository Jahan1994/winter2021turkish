...
public class Not {
    ...
    2) Hash : Isme gore sirali degildir. Her eleman olmasi gereken yerdedir. 
    Ve ayni kategoride olan birden fazla elemanlari birbirine linked eder.
    
    3) Tree : Dogal sirali demektir. {3, 6} diye kumem olsun . Bu kumeye 7'yi eklemek istersem java onu siralamaya gore koyar.
    {3,6,7} yapar . 5 eklemek istedigim zaman {3,5,6,7} . 
    Negatif tarafi yavastir cunku her elemani kontrol eder ve ona gore sayiyi koyar,
    burda yorar.
