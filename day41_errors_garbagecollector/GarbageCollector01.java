...
public class GarbageCollector01{
	...
	public static void main(String[] args) {
	  ...
	  2)final:final method overiide edilemez;final varaible degeri degistirlemez;finalclass child class sahibi olamaz.
	  finally(code bloc):try-catch blockdan sonra kullanilr ve Exception atilsada atilmasada calisir.
